...
Idents(longcovid_seurat) <- longcovid_seurat$CT_Sub
DefaultAssay(longcovid_seurat) <- "RNA"

# Create CellChat object for LongCovid
longcovid_cellchat <- createCellChat(object = longcovid_seurat, group.by = "CT_Sub")
...
# Save the Data Frame
write.csv(communication.df, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/communication_interactions_longcovid_CT_Sub.csv", row.names = FALSE)

# Infer the cell-cell communication at a signaling pathway level
longcovid_cellchat <- computeCommunProbPathway(longcovid_cellchat)
saveRDS(longcovid_cellchat, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/longcovid_cellchat_CT_Sub.rds")
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_number_longcovid_CT_Sub.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(longcovid_cellchat@net$count, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, title.name = "interaction number Long Covid")
dev.off()

png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_strength_longcovid_CT_Sub.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(longcovid_cellchat@net$weight, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, title.name = "interaction strength Long Covid")
dev.off()
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/LR_contribution_longcovid_CT_Sub/LR_contribution_longcovid_CT_Sub_", pathways.show.all[i], ".pdf"), 
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(filename = paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/violin_LR_long_covid_CT_Sub/violin_LR_long_covid_CT_Sub_", pathways.show.all[i], "_expression_longcovid.png"),
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_scatter_longcovid_CT_Sub.png", 
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_heatmap_longcovid_CT_Sub.png", 
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_outgoing_longcovid_CT_Sub.png")
nPatterns = 6
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/outgoing_patterns_longcovid_CT_Sub.png", 
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_incoming_longcovid_CT_Sub.png")
nPatterns = 4
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/incoming_patterns_longcovid_CT_Sub.png", 
    width = 10, height = 15, units = "in", res = 300)
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/netAnalysis_river_longcovid_CT_Sub.png", 
...
# Set cell identities to the "CT_Sub_combined" column and specify the default assay
Idents(control_seurat) <- control_seurat$CT_Sub
DefaultAssay(control_seurat) <- "RNA"

# Create CellChat object for Control
control_cellchat <- createCellChat(object = control_seurat, group.by = "CT_Sub")
...
write.csv(communication.df_control, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/communication_interactions_control_CT_Sub.csv", row.names = FALSE)
...
saveRDS(control_cellchat, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/control_cellchat_CT_Sub.rds")
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_number_control_CT_Sub.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(control_cellchat@net$count, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, title.name = "interaction number Control")
dev.off()

png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_strength_control_CT_Sub.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(control_cellchat@net$weight, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, title.name = "interaction strength Control")
dev.off()
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/LR_contribution_control_CT_Sub/LR_contribution_control_CT_Sub_", pathways.show.all[i], ".pdf"), 
         plot = gg, width = 13, height = 7, units = 'in', dpi = 600)
}
...
for (i in 1:length(pathways.show.all)) {
  ...
  # Save each violin plot to a png file
  ggsave(filename = paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/violin_LR_control_CT_Sub/violin_LR_control_CT_Sub_", pathways.show.all[i], "_expression_control.png"),
         plot = gg, width = 12, height = 7, dpi = 300)
}
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_scatter_control_CT_Sub.png", 
    width = 5, height = 5, units = "in", res = 500)
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_heatmap_control_CT_Sub.png", 
    width = 12, height = 12, units = "in", res = 500)
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_outgoing_control_CT_Sub.png")
nPatterns = 6
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/outgoing_patterns_control_CT_Sub.png", 
    width = 10, height = 15, units = "in", res = 300)
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_incoming_control_CT_Sub.png")
nPatterns = 4
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/incoming_patterns_control_CT_Sub.png", 
    width = 10, height = 15, units = "in", res = 300)
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/netAnalysis_river_control_CT_Sub.png", 
    width = 13, height = 15, units = "in", res = 500)
