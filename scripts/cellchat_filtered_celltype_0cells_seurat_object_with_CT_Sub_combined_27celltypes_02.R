...
# Save the Data Frame
write.csv(communication.df, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/communication_interactions_longcovid_27celltypes.csv", row.names = FALSE)

# Infer the cell-cell communication at a signaling pathway level
longcovid_cellchat <- computeCommunProbPathway(longcovid_cellchat)
saveRDS(longcovid_cellchat, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/longcovid_cellchat_27celltypes.rds")
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_number_longcovid_27celltypes.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(longcovid_cellchat@net$count, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, vertex.label.cex = 1.2, title.name = "interaction number Long Covid")
dev.off()

png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_strength_longcovid_27celltypes.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(longcovid_cellchat@net$weight, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, vertex.label.cex = 1.2, title.name = "interaction strength Long Covid")
dev.off()
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/LR_contribution_longcovid_27celltypes/LR_contribution_longcovid_27celltypes_", pathways.show.all[i], ".pdf"), 
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(filename = paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/violin_LR_long_covid_27celltypes/violin_LR_long_covid_", pathways.show.all[i], "_expression_longcovid_27celltypes.png"),
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_scatter_longcovid_27celltypes.png", 
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_heatmap_longcovid_27celltypes.png", 
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_outgoing_longcovid_27celltypes.png")
nPatterns = 6
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/outgoing_patterns_longcovid_27celltypes.png", 
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_incoming_longcovid_27celltypes.png")
nPatterns = 4
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/incoming_patterns_longcovid_27celltypes.png", 
    width = 10, height = 15, units = "in", res = 300)
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/netAnalysis_river_longcovid_27celltypes.png", 
...
# Set cell identities to the "CT_Sub_combined" column and specify the default assay
Idents(control_seurat) <- control_seurat$CT_Sub_combined_02
DefaultAssay(control_seurat) <- "RNA"

# Create CellChat object for Control
control_cellchat <- createCellChat(object = control_seurat, group.by = "CT_Sub_combined_02")
...
write.csv(communication.df_control, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/communication_interactions_control_27celltypes.csv", row.names = FALSE)
...
saveRDS(control_cellchat, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/control_cellchat_27celltypes.rds")
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_number_control_27celltypes.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(control_cellchat@net$count, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, vertex.label.cex = 1.2, title.name = "interaction number Control")
dev.off()

png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_strength_control_27celltypes.png", 
    width = 10, height = 12, units = "in", res = 500)
netVisual_circle(control_cellchat@net$weight, top = 0.1, arrow.width = 2, arrow.size = 0.5, edge.width.max = 10, weight.scale = TRUE, label.edge = TRUE, vertex.label.cex =1.2, title.name = "interaction strength Control")
dev.off()
...
for (i in 1:length(pathways.show.all)) {
  ...
  ggsave(paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/LR_contribution_control_27celltypes/LR_contribution_control_", pathways.show.all[i], ".pdf"), 
         plot = gg, width = 13, height = 7, units = 'in', dpi = 600)
}
...
for (i in 1:length(pathways.show.all)) {
  ...
  # Save each violin plot to a png file
  ggsave(filename = paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/violin_LR_control_27celltypes/violin_LR_control_", pathways.show.all[i], "_expression_control.png"),
         plot = gg, width = 12, height = 7, dpi = 300)
}
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_scatter_control_27celltypes.png", 
    width = 5, height = 5, units = "in", res = 500)
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/signalingRole_heatmap_control_27celltypes.png", 
    width = 12, height = 12, units = "in", res = 500)
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_outgoing_control_27celltypes.png")
nPatterns = 6
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/outgoing_patterns_control_27celltypes.png", 
    width = 10, height = 15, units = "in", res = 300)
...
ggsave("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/selectK_incoming_control_27celltypes.png")
nPatterns = 4
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/incoming_patterns_control_27celltypes.png", 
    width = 10, height = 15, units = "in", res = 300)
...
png(filename = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/netAnalysis_river_control_27celltypes.png", 
    width = 13, height = 15, units = "in", res = 500)
...
# Save the Data Frame
write.csv(communication.df, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/communication_interactions_combined_27celltypes.csv", row.names = FALSE)

# Infer the cell-cell communication at a signaling pathway level
seurat.cellchat <- computeCommunProbPathway(seurat.cellchat)
saveRDS(seurat.cellchat, file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/seurat_cellchat_combined_27celltypes.RDS")

# Load the saved CellChat object
seurat.cellchat <- readRDS(file = "/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/seurat_cellchat_combined_27celltypes.RDS")
...
for (i in 1:length(object.list)) {
  ...
  png(filename = paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_number_27celltypes_", names(object.list)[i], ".png"), 
  ...
  png(filename = paste0("/home/cyang40/chingyao/long_covid_project/merged_samples_02/long_covid_control_cellchat/interaction_strength_27celltypes_", names(object.list)[i], ".png"), 
      width = 10, height = 10, units = "in", res = 500)
